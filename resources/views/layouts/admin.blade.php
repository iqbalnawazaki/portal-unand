...
<body class="fix-header card-no-border">
    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav mr-auto mt-md-0">
                        ...
                        <li class="nav-item"> <a class="nav-link sidebartoggler text-muted waves-effect waves-dark" href="{{ url('/')}}">
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile" style="background: url({{asset('asset/assets/images/background/user-info.jpg')}}) no-repeat;">
                    ...
                    <!-- User profile text-->
                    <div class="profile-text"> <a href="#" class="dropdown-toggle u-dropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">{{ Auth::user()->name }}<br><small>{{ Auth::user()->nim }}</small></a>
                        <div class="dropdown-menu animated flipInY"> <a href="{{ url('/admin/profile')}}" class="dropdown-item"><i class="ti-user"></i> My Profile</a> <a href="#" class="dropdown-item"><i class="ti-wallet"></i> My Balance</a> <a href="#" class="dropdown-item"><i class="ti-email"></i> Inbox</a>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-account-settings-variant"></i><span class="hide-menu">Access Management</span></a>
                        ...
                        <li>
                            <a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Users Management</span></a>
                             <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ url('/admin/user')}}">Mahasiswa</a></li>
                                <li><a href="{{ url('/admin/dosen')}}">Dosen</a></li>
                            </ul>    
                        </li>
                        <li>
                            <a href="{{ url('/admin/postingan')}}" aria-expanded="false"><i class="mdi mdi-comment-text"></i><span class="hide-menu">Postingan</span></a>
                        </li>
                         <li>
                            <a href="{{ url('/admin/periode')}}" aria-expanded="false"><i class="mdi mdi-timetable"></i><span class="hide-menu">Periode</span></a>
                        </li>
                         <li>
                            <a href="{{ url('/admin/topik-bimbinganakademik')}}" aria-expanded="false"><i class="mdi mdi-timetable"></i><span class="hide-menu">Topik BA</span></a>
                        </li>
                    </ul>
                </nav>
        ...
        <div class="page-wrapper">
            ...
            <!-- ============================================================== -->
            <footer class="footer">
                © 2018 Portal Akademik Universitas Andalas
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
