        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile" style="background: url({{asset('asset/assets/images/background/user-info.jpg')}}) no-repeat;">
                    ...
                    <!-- User profile text-->
                    <div class="profile-text"> <a href="#" class="dropdown-toggle u-dropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">{{ Auth::user()->name }}<br><small>{{ Auth::user()->id }}</small></a>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a href="{{ url('/bimbingan-akademik')}}" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Bimbingan Akademik</span></a>
                        </li>
                    </ul>
                </nav>
