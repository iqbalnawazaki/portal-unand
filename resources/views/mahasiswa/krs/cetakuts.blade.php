...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('asset/assets/images/unand-logo')}}">
...
<h5 class="text-center">TENGAH SEMESTER : {{ $max->semester_nama }} {{ $max->semester_tahun }} / {{ $max->semester_tahun + 1 }}</h5>
             ...
             <tr>
               ...
               <td class="text-center">  
                    @foreach($ujian as $ruang)
                        @if($ruang->semesterkelas == $max->semester_id && $ruang->kelasnama == $item->namakelas && $ruang->jenisujian == "T" )
